<template>
  <div class='homo'>
    ...
    <h3 style="background-color:aqua">组件通讯---现在总人数是: {{personList.length}} </h3>
    <!-- 模板里简写,school是没简写的 -->
...
export default {
  ...
  methods: {
    ...
    //   }, 1000);
    // },
    ...mapMutations('a',{increment:'JIA',decrement:'JIAN'}),//(对象写法),也有数组写法
    ...mapActions('a',{incrementOdd:'jiaOdd',incrementWait:'jiaTime'})
    //dispatch分部
  },
  computed: {
  ...mapState('a',['sum', 'school', 'student']),
